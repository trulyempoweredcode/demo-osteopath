...
(function () {
  ...
  if (sidebar) {
    ...
    if (serviceSections.length) {
      var navHtml = '<p class="services-sidebar__heading">Services</p><nav class="services-sidebar__nav">';
      ...
      navHtml += '</nav>';
      navHtml += '<a href="contact.html" class="btn btn--primary services-sidebar__btn">Book a Call</a>';
      navHtml += '<a href="contact.html" class="btn btn--secondary services-sidebar__btn">Free Discovery Call</a>';
